<?php
if (!function_exists('sign_bcdn_url')) {

    function sign_bcdn_url($name, $user_ip = null, $is_directory_token = false, $path_allowed = NULL, $countries_allowed = NULL, $countries_blocked = NULL)
    {    
        $url = env('BUNNYCDN_PULL_ZONE') . $name;
        $securityKey = env('BUNNYCDN_PULL_ZONE_API_KEY');
        $expiration_time = 600;
        $referers_allowed = env('BUNNYCDN_REFERENCE');
